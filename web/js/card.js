...
function doFun(){
 tColorA.style.color = "#2C2C3E";
 tColorB.style.color = "#444";
 tColorC.style.color = "#444";
 iconA.style.color = "#2C2C3E";
...
function doFunA(){
 ...
 tColorB.style.color = "#2C2C3E";
 tColorC.style.color = "#444";
 iconA.style.color = "#aaa";
 iconB.style.color = "#2C2C3E";
 iconC.style.color = "#aaa";
...
function doFunB(){
 tColorA.style.color = "#444";
 tColorB.style.color = "#444";
 tColorC.style.color = "#2C2C3E";
 iconA.style.color = "#aaa";
 iconB.style.color = "#aaa";
 iconC.style.color = "#2C2C3E";
 cDetails.style.display = "none";
}
